...
- *Slider Gambar Otomatis*  
  Menampilkan produk unggulan dengan tombol navigasi dan auto-slide setiap 3 detik.

- *Mode Gelap (Dark Mode)*  
  Pengguna dapat mengaktifkan mode gelap untuk tampilan yang lebih nyaman di malam hari.
...
Silakan fork dan modifikasi sesuai kebutuhan. Proyek ini cocok untuk latihan front-end, tugas akhir, atau demo portofolio.
